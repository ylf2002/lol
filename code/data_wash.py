...
df = pd.read_excel(r"E:\大二下\人工智能基础\crawl\lol\data\first_lol_role_data.xls")
...
data.to_csv("E:\\大二下\\人工智能基础\\crawl\\lol\\data\\clean_lol_role_data.csv",index=False)
...
df_new.to_csv("E:\\大二下\\人工智能基础\\crawl\\lol\\data\\clean_lol_role_data_length.csv",index=False)
...
# 替换
df_new['职业'] = df_new['职业'].map(roles_mapping)
df_new.to_csv("E:\\大二下\\人工智能基础\\crawl\\lol\\data\\roles.csv", index=False, header=False)
